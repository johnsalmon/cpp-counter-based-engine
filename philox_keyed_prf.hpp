...
using philox2x32_kprf = philox_keyed_prf<32, 2, R, 0xD256D193, 0x9E3779B9>;
template<unsigned R=10>
using philox4x32_kprf = philox_keyed_prf<32, 4, R, 0xD2511F53, 0x9E3779B9,
                                                    0xCD9E8D57, 0xBB67AE85>;

template <unsigned R=10>
using philox2x64_kprf = philox_keyed_prf<64, 2, R, 0xD2B74407B1CE6E93, 0x9E3779B97F4A7C15>;
template <unsigned R=10>
using philox4x64_kprf = philox_keyed_prf<64, 4, R, 0xD2E7470EE14C6C93, 0x9E3779B97F4A7C15,
